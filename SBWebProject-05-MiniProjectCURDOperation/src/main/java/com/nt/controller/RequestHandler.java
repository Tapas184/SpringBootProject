...
public class RequestHandler {
	...
	/*
	 * @PostMapping("/add")
	 *  public String inserTingEmployee(RedirectAttributes rda,@ModelAttribute("emp") EmployeeModel emp) { //Invoke the b-logic 
	 *  String result = service.insertEmployee(emp); 
	 * rda.addFlashAttribute("resultMsg",result); //redirect for PostRedirect problem 
