...
<f:form modelAttribute="emp" onsubmit="return validate(this)">
   ...
   <f:errors path="*"/>
	...
	<table style="background-color: pink" align="center">
		...
		<tr>
			<td>Employee Name ::</td>
			<td><f:input path="ename" onfocus="Enter Employee Name" /> <f:errors
					cssStyle="color:red" path="ename" /><span style="color: red"
				id="enameError"></span></td>
		</tr>
		<tr>
			<td>Employee Salary ::</td>
			<td><f:input path="sal" onfocus="Enter Employee Salary" /> <f:errors
					cssStyle="color:red" path="sal" /><span style="color: red"
				id="salError"></span></td>
		</tr>
		<tr>
			<td>Employee Position ::</td>
			<td><f:input path="job" onfocus="Enter Employee Job" /> <f:errors
					cssStyle="color:red" path="job" /><span style="color: red"
				id="jobError"></span></td>
		</tr>
		<tr>
