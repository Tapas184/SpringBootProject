...
<f:choose>
	<f:when test="${!empty emplist}">
		<table style="margin-left: auto; margin-right: auto; color: pink" border="1">
			<tr bgcolor="yellow">
				<th>EmpNo</th>
				<th>EmpName</th>
				<th>Job</th>
...
<span style="color: Green;text-align: center;">${resultMsg}</span>
<br>
<h3 style="text-align: center;">
	<a href="add"><img src="logo/add.png" height="50" width="50"><br> Add_Employee</a>
	<br><br> <a href="./"><img src="logo/Home.png" height="50" width="50"><br>Home</a>
</h3>