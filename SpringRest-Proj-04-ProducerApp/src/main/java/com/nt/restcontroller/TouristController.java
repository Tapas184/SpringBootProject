...
public class TouristController {
	...
	public ResponseEntity<String> deleteTourist(@PathVariable("id") Integer id){ //Method for delete
		String deleteTourist = service.deleteTourist(id);  // call the service method
